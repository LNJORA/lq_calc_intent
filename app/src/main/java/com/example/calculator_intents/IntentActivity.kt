package com.example.calculator_intents
...
class IntentActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            com.example.calculator_intents.Intent()
...
fun Intent() {
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {val takePictureIntent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
        ...
        OutlinedButton(
            onClick = {val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "+918511812660"))
